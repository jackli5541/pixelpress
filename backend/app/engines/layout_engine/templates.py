...
STYLE_PRESETS: dict[str, dict[str, Any]] = {
    "minimal": {
        ...
        "body_font": "'Noto Sans CJK SC', 'Noto Sans SC', 'Microsoft YaHei', sans-serif",
    ...
    "editorial": {
        "label": "Editorial",
        "heading_font": "'Times New Roman', 'Noto Sans CJK SC', serif",
        "body_font": "'Arial', 'Noto Sans CJK SC', sans-serif",
        "display_font": "'Baskerville Old Face', 'Times New Roman', 'Noto Sans CJK SC', serif",
    ...
    "warm_family": {
        "label": "Warm Family",
        "heading_font": "'Trebuchet MS', 'Microsoft YaHei', 'Noto Sans CJK SC', sans-serif",
        "body_font": "'Microsoft YaHei', 'Noto Sans CJK SC', sans-serif",
        "display_font": "'Trebuchet MS', 'Microsoft YaHei', 'Noto Sans CJK SC', sans-serif",
    ...
    "playful_child": {
        "label": "Playful Child",
        "heading_font": "'Comic Sans MS', 'Microsoft YaHei', 'Noto Sans CJK SC', sans-serif",
        "body_font": "'Microsoft YaHei', 'Noto Sans CJK SC', sans-serif",
        "display_font": "'Comic Sans MS', 'Microsoft YaHei', 'Noto Sans CJK SC', sans-serif",
