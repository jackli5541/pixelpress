...
STYLE_PRESETS: dict[str, dict[str, Any]] = {
    ...
    "editorial": {
        "label": "Editorial",
        "heading_font": "'Times New Roman', SimSun, 'Noto Serif CJK SC', 'Liberation Serif', serif",
        "body_font": "Arial, 'Microsoft YaHei', 'Noto Sans CJK SC', 'Liberation Sans', sans-serif",
        "display_font": "'Times New Roman', SimSun, 'Noto Serif CJK SC', 'Liberation Serif', serif",
    ...
    "warm_family": {
        "label": "Warm Family",
        "heading_font": "'Trebuchet MS', 'Microsoft YaHei', 'Noto Sans CJK SC', 'Liberation Sans', sans-serif",
        "body_font": "'Microsoft YaHei', Arial, 'Noto Sans CJK SC', 'Liberation Sans', sans-serif",
        "display_font": "'Trebuchet MS', 'Microsoft YaHei', 'Noto Sans CJK SC', 'Liberation Sans', sans-serif",
    ...
    "playful_child": {
        "label": "Playful Child",
        "heading_font": "'Comic Sans MS', 'Microsoft YaHei', 'Noto Sans CJK SC', 'Liberation Sans', sans-serif",
        "body_font": "'Microsoft YaHei', Arial, 'Noto Sans CJK SC', 'Liberation Sans', sans-serif",
        "display_font": "'Comic Sans MS', 'Microsoft YaHei', 'Noto Sans CJK SC', 'Liberation Sans', sans-serif",
