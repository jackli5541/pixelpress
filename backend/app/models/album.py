...
class Album(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    layout_version: Mapped[str] = mapped_column(String(32), default="legacy_page_v1", nullable=False)
    ...
    spreads = relationship("Spread", back_populates="album", cascade="all, delete-orphan")
